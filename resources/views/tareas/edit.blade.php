...
<font color="#367068"><h1><i class="fas fa-tasks"> Editar Tareas existentes para  roles dentro del Notrijez </i></h1></font>
@stop
                        ...
                        <div class="form-group ">
                            ...
                            <div class="">
                                <input id="descripcion" type="text" class="form-control @error('descripcion') is-invalid @enderror"
                                 name="descripcion" value="{{ old('descripcion', $tarea->descripcion) }}" required autocomplete="descripcion" autofocus>
