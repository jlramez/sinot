...
<font color="#367068"><h1><i class="fas fa-check-double">Editar documento(s) para certificación en las actuaciones de los expedientes  del TRIJEZ</i></h1></font>
@stop

@section('content')
            <div class="card">
                <div class="card-header">{{ __('Asigna documentos a actuación: ') }}{{$certificaciones->asigna_actuaciones->actuacions->Nombre}}</div>
                    <div class="card-body">
                     @if (session('status'))
                     ...
                     @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('store_cert', $certificaciones->id) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                        ...
                        <div class="form-group ">
                            ...
                            <div class="">
                                <input id="folio" type="text" class="form-control @error('folio') is-invalid @enderror" name="folio" value="{{ old('folio', $certificaciones->asigna_actuaciones->folio) }}" required autocomplete="folio" disabled>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="">
                                <input id="actuacion" type="text" class="form-control @error('actuacion') is-invalid @enderror" name="actuacion" value="{{ old('folio',$certificaciones->asigna_actuaciones->actuacions->Nombre) }}" required autocomplete="folio" disabled>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="">
                            <input id="magistrado" type="text" class="form-control @error('magistrado') is-invalid @enderror" name="magistrado" value="{{ old('magistrado', $certificaciones->asigna_actuaciones->expedientes->ponencias->magistrados->nombre.' '. $certificaciones->asigna_actuaciones->expedientes->ponencias->magistrados->primerapellido.' '. $certificaciones->asigna_actuaciones->expedientes->ponencias->magistrados->segundoapellido) }}" required autocomplete="magistrado" disabled>
