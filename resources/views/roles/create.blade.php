...
@section('title', 'Crear Roles de usuario')

@section('content_header')
<font color="#367068"><h1><i class="fas fa-user-tag">Crear roles de usuario del Sistema Notrijez</i></h1></font>
@stop
            ...
            <div class="card">
                <div class="card-header">{{ __('Nuevo ') }}</div>
                    <div class="card-body">
                     ...
                     @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('store_rol') }}">
                        @csrf

                        <div class="form-group ">
                            <label for="descripción" >{{ __('Nombre del rol') }}</label>
