...
@section('title', 'Crear Ponencias')

@section('content_header')
<font color="#367068"><h1><i class="fas fa-briefcase"> Crear ponencia del Tribunal de Justicia Electoral del Estado de Zacatecas</i></h1></font>
@stop
@section('content')
            ...
            <div class="card">
                <div class="card-header">{{ __('Nueva ') }}</div>
                    <div class="card-body">
                     ...
                     @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('store_ponencia') }}">
                        @csrf
