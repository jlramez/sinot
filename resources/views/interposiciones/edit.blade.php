...
@section('content_header')
    <<font color="#367068">h1><i class="fas fa-share-square">Editar Interposiciones de los  expedientes dentro del Notrijez</i></h1></font>
@stop
            ...
            <div class="card">
                <div class="card-header">{{ __('Editar ') }}</div>
                    <div class="card-body">
                     ...
                     @endif
                <div class="card-body">
                    <form method="POST" action="{{url('interposicion/'.$interposicion->id) }}">
                    @method('put')
                        @csrf
                        ...
                        <div class="form-group ">
                            ...
                            <div class="">
                                <input id="descripcion" type="text" class="form-control @error('descripcion') is-invalid @enderror"
                                 name="descripcion" value="{{ old('descripcion', $interposicion->descripcion) }}" required autocomplete="descripcion" autofocus>
