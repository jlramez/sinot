...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Nueva Interposición') }}</div>
                    <div class="card-body">
                     @if (session('status'))
                     ...
                     @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('store_interposicion') }}">
                        @csrf

                        <div class="form-group ">
                            <label for="descripción" >{{ __('Nombre de la interposición') }}</label>
            ...
            <div class="card-footer" align="right"> 
                      <a href="{{ url( 'interposicion/admin')}}"" class="btn btn-success" ><i class="fas fa-check-circle"></i>Aceptar</a> 
            </div>
        </div>
    </div>
</div>
